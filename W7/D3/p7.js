...
const userToken = jwt.sign({ userId: 1, role: "user", email: "varsh@email.com" }, secretKey, { expiresIn: "1h" });
console.log("Usertoken:",userToken);
const adminToken = jwt.sign({ userId: 2, role: "admin", email: "rhaa@email.com" }, secretKey, { expiresIn: "1h" });
